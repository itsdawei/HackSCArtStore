...
export default class XrpClient implements XrpClientInterface {
     ...
     */
    constructor(grpcUrl: string, network: XrplNetwork, forceWeb?: boolean);
    /**
     ...
     */
    sendXrp(amount: BigInteger | number | string, destination: string, sender: Wallet): Promise<TransactionResult>;
    /**
