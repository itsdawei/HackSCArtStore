...
class TransactionResult {
     ...
     */
    constructor(hash, status, validated, final) {
        this.hash = hash;
        this.status = status;
     ...
     * @param validated Whether this transaction (and status) are included in a validated ledger.
     */
    static createPendingTransactionResult(hash, status, validated) {
     ...
     * @param validated Whether this transaction (and status) are included in a validated ledger.
     */
    static createFinalTransactionResult(hash, status, validated) {
