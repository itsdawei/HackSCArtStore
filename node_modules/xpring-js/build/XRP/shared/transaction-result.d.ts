...
export default class TransactionResult {
     ...
     */
    static createPendingTransactionResult(hash: string, status: TransactionStatus, validated: boolean): TransactionResult;
    /**
     ...
     * @param validated Whether this transaction (and status) are included in a validated ledger.
     */
    static createFinalTransactionResult(hash: string, status: TransactionStatus, validated: boolean): TransactionResult;
    /**
     * @param hash The identifying hash of the transaction.
     * @param status The result of the transaction.
     * @param validated Whether this transaction (and status) are included in a validated ledger.
