...
export class SubmitTransactionRequest extends jspb.Message { 
    ...
    setSignedTransaction(value: Uint8Array | string): SubmitTransactionRequest;

    getFailHard(): boolean;
    setFailHard(value: boolean): SubmitTransactionRequest;
...
export class SubmitTransactionResponse extends jspb.Message { 
    ...
    setEngineResult(value?: org_xrpl_rpc_v1_meta_pb.TransactionResult): SubmitTransactionResponse;

    getEngineResultCode(): number;
    setEngineResultCode(value: number): SubmitTransactionResponse;

    getEngineResultMessage(): string;
    setEngineResultMessage(value: string): SubmitTransactionResponse;
