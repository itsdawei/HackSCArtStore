...
export class LedgerSpecifier extends jspb.Message { 
    ...
    setShortcut(value: LedgerSpecifier.Shortcut): LedgerSpecifier;


    hasSequence(): boolean;
    clearSequence(): void;
    getSequence(): number;
    setSequence(value: number): LedgerSpecifier;
    ...
    setHash(value: Uint8Array | string): LedgerSpecifier;
...
export class LedgerRange extends jspb.Message { 
    ...
    setLedgerIndexMin(value: number): LedgerRange;

    getLedgerIndexMax(): number;
    setLedgerIndexMax(value: number): LedgerRange;
