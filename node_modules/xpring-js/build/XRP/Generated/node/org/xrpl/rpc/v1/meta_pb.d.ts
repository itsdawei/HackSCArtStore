...
export class Meta extends jspb.Message { 
    ...
    setDeliveredAmount(value?: org_xrpl_rpc_v1_common_pb.DeliveredAmount): Meta;
...
export class TransactionResult extends jspb.Message { 
    ...
    setResultType(value: TransactionResult.ResultType): TransactionResult;

    getResult(): string;
    setResult(value: string): TransactionResult;
...
export class CreatedNode extends jspb.Message { 
    ...
    setNewFields(value?: org_xrpl_rpc_v1_ledger_objects_pb.LedgerObject): CreatedNode;
...
export class DeletedNode extends jspb.Message { 
    ...
    setFinalFields(value?: org_xrpl_rpc_v1_ledger_objects_pb.LedgerObject): DeletedNode;
...
export class ModifiedNode extends jspb.Message { 
    ...
    clearFinalFields(): void;
    getFinalFields(): org_xrpl_rpc_v1_ledger_objects_pb.LedgerObject | undefined;
    setFinalFields(value?: org_xrpl_rpc_v1_ledger_objects_pb.LedgerObject): ModifiedNode;
    ...
    setPreviousFields(value?: org_xrpl_rpc_v1_ledger_objects_pb.LedgerObject): ModifiedNode;
    ...
    setPreviousTransactionId(value?: org_xrpl_rpc_v1_common_pb.PreviousTransactionID): ModifiedNode;
    ...
    setPreviousTransactionLedgerSequence(value?: org_xrpl_rpc_v1_common_pb.PreviousTransactionLedgerSequence): ModifiedNode;
